...
from hoffman.solvers.base_sparse_solver import BaseSparseSolver
...
class SensitivityAnalysis:
    ...
    def compute_stability_random_perturbations(
        design: DesignMatrix, solver: BaseSparseSolver, n_perturbations: int = 20, noise_level: float = 0.01
    ...
    def compute_stability_cross_validation(
        design: DesignMatrix, solver: BaseSparseSolver, n_folds: int = 5, noise_level: float = 0.01, random_seed: int = 0
    ) -> SensitivityAnalysisMetrics:
